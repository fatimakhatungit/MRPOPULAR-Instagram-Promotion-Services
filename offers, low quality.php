    ...
    <body>
        ...
        <header>
            ...
            <div class="after_body">
                ...
                <input name="title" type="hidden" value="offers, low quality">
                <input name="id" type="hidden" value="249">
                <h1>Instagram followers</h1>
                <p>offers, low quality</p>
                <p class="cart_dop"><i class="fas fa-play"></i>start 5 hr.</p>
                <p class="cart_dop"><i class="fas fa-tachometer-alt"></i>1K/day</p>
                <p class="cart_dop"><i class="fas fa-battery-quarter"></i>min 100&nbsp;</p>
                ...
                <input autocomplete="off" id="_shop_qnty" real_price="0.25" price="0.0031" qnty_min="100" type="text" name="_shop_qnty">
                <p class="l_gray" style="border-top:unset;"><span id="qnty">100</span> х <span id="price">$0.0031</span> = $<span id="bill">0.31</span> </p>
