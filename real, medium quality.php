...
<html class="no-js" lang="">
    ...
    <body>
        ...
        <header>
            ...
            <p><a href="/">home</a><a href="/?category=socialnetworks&amp;type=Instagram">Instagram</a><a class="dis_after" href="/?category=socialnetworks&amp;type=Instagram&amp;service=followers">followers</a></p>
            </div>
            <div class="op">
            <div id="balance">
            ...
            <div class="after_body">
                ...
                <input name="name" type="hidden" value="followers">
                <input name="title" type="hidden" value="real, medium quality">
                <input name="id" type="hidden" value="58">
                <h1>Instagram followers</h1>
                <p>real, medium quality</p>
                <p class="cart_dop"><i class="fas fa-play"></i>start 5 hr.</p>
                <p class="cart_dop"><i class="fas fa-tachometer-alt"></i>50K/day</p>
                <p class="cart_dop"><i class="fas fa-battery-quarter"></i>min 50&nbsp;</p>
                ...
                <input autocomplete="off" id="_shop_qnty" real_price="5.4" price="0.0675" qnty_min="50" type="text" name="_shop_qnty">
                <p class="l_gray" style="border-top:unset;"><span id="qnty">50</span> х <span id="price">$0.0675</span> = $<span id="bill">3.375</span> </p>
