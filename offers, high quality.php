    ...
    <body>
        ...
        <header>
            ...
            <div class="after_body">
                ...
                <input name="id" type="hidden" value="284">
                ...
                <input autocomplete="off" id="_shop_qnty" real_price="0.75" price="0.0094" qnty_min="100" type="text" name="_shop_qnty">
                <p class="l_gray" style="border-top:unset;"><span id="qnty">100</span> х <span id="price">$0.0094</span> = $<span id="bill">0.94</span> </p>
