    ...
    <body>
        ...
        <header>
            ...
            <div class="after_body">
                ...
                <input name="title" type="hidden" value="real, low quality">
                <input name="id" type="hidden" value="56">
                <h1>Instagram followers</h1>
                <p>real, low quality</p>
                ...
                <input autocomplete="off" id="_shop_qnty" real_price="1.8" price="0.0225" qnty_min="100" type="text" name="_shop_qnty">
                <p class="l_gray" style="border-top:unset;"><span id="qnty">100</span> х <span id="price">$0.0225</span> = $<span id="bill">2.25</span> </p>
