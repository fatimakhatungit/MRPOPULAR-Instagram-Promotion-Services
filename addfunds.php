...
<html class="no-js" lang="">
    ...
    <body>
        ...
        <div class="after_body">
          ...
          <p>Add funds and buy with 1-Click</p>
          </div>
          <div class="form b_shop" id="_shop_cart">
          <div id="reg_changeToLogin"><p style="padding-top:0;padding:0 15px;border:unset;background:black">You're not currently signed in. <a style="cursor:pointer!important;" href="login.php">Log in</a> or <a style="cursor:pointer!important;" href="register.php">sign up</a></p></div> </div>
          </div>
          </div>
          </div>
