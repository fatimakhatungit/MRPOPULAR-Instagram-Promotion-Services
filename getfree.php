    ...
    <body>
        ...
        <header>
            ...
            <div class="after_body">
                ...
                <h1>Free Social Media Boost and Promotion</h1>
                <img class="formPart" src="img/header.jpg" alt="MRPOPULAR">
                <p>You will find the list of all free promotion methods below</p>
                <hr>
                <p class="l_gray great_text">Get <a style="width: unset;padding: unset;" href="get-free-instagram-likes.php">free Instagram likes</a>.</p>
                <hr>
                <p class="l_gray great_text">Get <a style="width: unset;padding: unset;" href="get-free-instagram-followers.php">free Instagram followers</a>.</p>
                <hr>
                <p class="l_gray great_text">Get <a style="width: unset;padding: unset;" href="get-free-tt-followers.php">free TT followers</a>.</p>
                <hr>
                <p class="l_gray great_text">Get <a style="width: unset;padding: unset;" href="get-free-tt-views.php">free TT views</a>.</p>
                <hr>
                <p class="l_gray great_text">Get <a style="width: unset;padding: unset;" href="get-free-tt-likes.php">free TT likes</a>.</p>
                <hr>
                <p class="l_gray great_text">Get <a style="width: unset;padding: unset;" href="get-free-telegram-subscribers.php">free Telegram subscribers</a>.</p>
                <hr>
                <p class="l_gray great_text">Get <a style="width: unset;padding: unset;" href="get-free-smm-boost.php">free promotion</a> for advertising our service.</p>
                </div>
                <div class="form_block">
                <a href="MRPOPULAR.zip">Promotion banners</a>
                </div>
                </div>
                </div>
                </div>
        ...
        <script src="js/getfree.js"></script>
