...
<h1>Get Free TT Views</h1>
<img class="formPart" src="img/header.jpg" alt="MRPOPULAR">
<p>Provide a link to your Instagram profile and get new followers for free in 5 minutes.</p>
<hr>
...
<div class="captchaBlock">
     <div class="g-recaptcha" data-sitekey="6Lfsr9saAAAAAJGVywL3RDd3s_3ATBuimMZfo2Gm">
              </div>

<div class="g-recaptcha" data-sitekey="6LcDqvsZAAAAABmU0zFnqZ_NX9IcnH5olLFVIVHt"><div style="width: 304px; height: 78px;"><div></div><textarea id="g-recaptcha-response" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div><iframe style="display: none;"></iframe></div>
</div>
...
<hr>
<p class="l_gray great_text">Need more, faster, and higher qiality? <a style="width: unset;padding: unset;" href="followers.php">Make an order here</a>.</p>
</div>
</div>
</div>
