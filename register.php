    ...
    <body>
        ...
        <header>
            ...
            <div class="after_body">
                ...
                <p>Fill out the required form</p>
                <hr>
                <label for="username_reg">username</label>
                <input id="username_reg" type="text" name="username_reg">
                <br><hr>
                <label for="email_reg">Email</label>
                <input id="email_reg" type="email" name="email_reg">
                <br><hr>
                <label for="password_reg">password</label>
                <input id="password_reg" type="password" name="password_reg">
                <br>
                <hr>
                <input disabled="" style="width:unset!important; vertical-align: middle; margin: 10px;" checked="checked" id="terms_accept" type="checkbox" name="terms_accept">
                <span style="font-size: 9px; font-family: 'Open Sans';">I accept the <a href="/docs/en_terms of service.zip" style="width: unset; padding: unset;">Terms of Service</a></span>
                <br><hr>
                <button id="submit_reg">Sign up</button>
                </div>
                <div id="reg_changeToLogin"><p>Already have an account, <a href="login.php">log in</a></p></div>
                </div>
                </div>
