...
<html class="no-js" lang="">
    ...
    <body>
        ...
        <div id="pre_b">
          ...
          <header>
            ...
            <div class="after_body">
              ...
              <h1>Get Free Instagram Likes</h1>
              <img class="formPart" src="img/header.jpg" alt="MRPOPULAR">
              <p>Just put the link to an Instagram post and get likes for free in 5 minutes.</p>
              <hr>
              <div class="fcreen fullscreen_seo_block" id="freePromoBlock">
              <div class="global_tool">
                <div class="form">
                  <form id="freePromoForm" err="Please solve the Captcha below to proceed.">
                  <label for="link">Link to a post</label>
                  <input type="text" name="link" id="link">
                  <input type="hidden" id="avalQ" value="1">
                  <div class="captchaBlock">
                  <div class="g-recaptcha" data-sitekey="6LcDqvsZAAAAABmU0zFnqZ_NX9IcnH5olLFVIVHt"><div style="width: 304px; height: 78px;"><div>
                    
                  </div><textarea id="g-recaptcha-response" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div><iframe style="display: none;"></iframe></div>
                  </div>
                  <div id="hide"><button id="freePromoRun" alttext="Get"><span class="gethide">Get</span></button></div>

                  <button id="gettimerCall" alttext="Get" class="buttontimerCall"><i class="far fa-clock"></i>Available in <span id="timerCall">1:52</span> <span>minutes</span>.</button>
                  </form>
                  </div>
              ...
              <div class="form_block">
              <p>Wait 5 minutes while staying on this page and you will be able to order again. If you don't want to wait, come back in an hour.</p>
              <hr>
              <p class="l_gray great_text">Need more, faster, and higher qiality? <a style="width: unset;padding: unset;" href="likes.php">Make an order here</a>.</p>
              </div>
              </div>
              </div>
        ...
        <script src="js/watch.js"></script>  
         <script src="js/getfree.js"></script></div>
