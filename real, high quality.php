    ...
    <body>
        ...
        <header>
            ...
            <div class="after_body">
                ...
                <input name="title" type="hidden" value="real, high quality">
                <input name="id" type="hidden" value="59">
                <h1>Instagram followers</h1>
                <p>real, high quality</p>
                ...
                <input autocomplete="off" id="_shop_qnty" real_price="9.9" price="0.1238" qnty_min="50" type="text" name="_shop_qnty">
                <p class="l_gray" style="border-top:unset;"><span id="qnty">50</span> х <span id="price">$0.1238</span> = $<span id="bill">6.19</span> </p>
