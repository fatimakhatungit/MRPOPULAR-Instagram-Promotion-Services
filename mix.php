    ...
    <body>
        ...
        <header>
            ...
            <div class="after_body">
                ...
                <input name="title" type="hidden" value="mix">
                <input name="id" type="hidden" value="588">
                <h1>Instagram followers</h1>
                <p>mix</p>
                <p class="cart_dop"><i class="fas fa-play"></i>start 24 hr.</p>
                <p class="cart_dop"><i class="fas fa-tachometer-alt"></i>50K/day</p>
                <p class="cart_dop"><i class="fas fa-battery-quarter"></i>min 250&nbsp;</p>
                ...
                <input autocomplete="off" id="_shop_qnty" real_price="1.65" price="0.0206" qnty_min="250" type="text" name="_shop_qnty">
                <p class="l_gray" style="border-top:unset;"><span id="qnty">250</span> х <span id="price">$0.0206</span> = $<span id="bill">5.15</span> </p>
